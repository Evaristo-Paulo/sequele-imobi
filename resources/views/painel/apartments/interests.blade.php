    ...
    <div class="col-lg-12 col-ml-12">
        ...
        <div class="row">
            <div class="col-12 mt-5">
                ...
                @endif
                @if( session('interest-not-found') )
                    <ul class="alert alert-warning " role="alert">
                        <li><i class="fa fa-warning"></i> {{ session('interest-not-found') }}</li>
                    </ul>
                @endif
                @if( session('error') )
                    <ul class="alert alert-warning " role="alert">
                                ...
                                <tbody>
                                    @forelse($interests as $key => $interest)
                                        <tr>
                                            ...
                                            <td>{{ $interest->apt_id }}</td>
                                            <td>{{ $interest->collaborator }}</td>
                                            <td class="option-data">
                                                @can('just-admin-and-collaborator')
                                                    <form action="{{ route('interests.remove') }}"
