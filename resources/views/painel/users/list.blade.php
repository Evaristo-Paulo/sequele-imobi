                            ...
                            <table id="dataTable2" class="text-center my-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $user['gender'] }}</td>
                                        <td>{{ $user['email'] }}</td>
                                        <td>{{ implode(', ', $user['role']) }}</td>
                                        <td class="option-data">
                                            @can('only-admin')
                                                @if ($user['id'] == Auth::user()->id)
                                                    <a href="#" class="btn text-info"><i class="fa fa-refresh"
                                                ...
                                                @else
                                                <a href="{{ route('users.update.form', encrypt($user['id']) ) }}" class="btn text-info"><i class="fa fa-refresh"
                                                    aria-hidden="true"></i> <span class="option-title"></span></a>
                                                <form action="{{ route('users.remove') }}"
